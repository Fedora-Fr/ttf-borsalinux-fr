<?php
/**
 * TTF Borsalinux-Fr functions and definitions.
 *
 * @link https://developer.wordpress.org/themes/basics/theme-functions/
 *
 * @package WordPress
 * @subpackage TTF_BorsalinuxFr
 * @since TTF Borsalinux-Fr 1.0
 */
 ...
 * @return void
 */
function ttf_borsalinuxfr_enqueue_styles(): void {
	wp_enqueue_style(
		'ttf-borsalinuxfr-style',
 ...
 * @return void
 */
function ttf_borsalinuxfr_block_assets(): void {
	wp_enqueue_style(
		'ttf-borsalinuxfr-block',
 ...
 */
function ttf_borsalinuxfr_clean_wp_head(): void {
 ...
 */
function ttf_borsalinuxfr_exclude_sticky_from_main_query( $query ) {
...
add_action( 'pre_get_posts', 'ttf_borsalinuxfr_exclude_sticky_from_main_query' );
